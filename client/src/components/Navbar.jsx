  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        setLoading(true);
        await axios
          .get(`http://192.168.0.112:4000/api/users/${userId}`, config)
          .then((response) => {
    ...
    <>
      {userData?.username ? (
        <div className="fixed w-full p-2">
          <div className="bg-white flex flex-row justify-between items-center  px-6 rounded-lg shadow-xl shadow-black text-center">
            <div className="flex">
